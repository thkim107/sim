...
# IN:
# OUT: X_train, X_test, y_train, y_test, tdim, dim
# Goal: pack train/test features with labels from .h5 data.
...
# IN: cover1, cover2, chroma_dim
# OUT: cover1, cover2_shifted
# Goal: Optimal transposition index (OTI) implementation, returns transposed chromas
#
def oti(cover1,cover2,chroma_dim): 
